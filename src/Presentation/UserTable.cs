    ...
    public static void EditUsers()
        {
            ...
            do
            {
                ...
                Console.BackgroundColor = ConsoleColor.Black;
                Console.Write($"├─{new string('─', Math.Max(0, 4 ))}─┤\n");
                Console.Write($"│─firstname{new string('─', Math.Max(0, firstMax - 9 ))}─┬─LastName{new string('─', Math.Max(0, lastMax - 8  ))}─┬─Email{new string('─', Math.Max(0, mailMax - 5 ))}─┬─Password{new string('─', Math.Max(0, passMax - 8 ))}─┐\n");
                ...
                Console.Write($"└─{new string('─', Math.Max(0, firstMax ))}─┴─{new string('─', Math.Max(0, lastMax ))}─┴─{new string('─', Math.Max(0, mailMax ))}─┴─{new string('─', Math.Max(0, passMax ))}─┘");
                Console.Write($"\n");
                ...
                else if (key == ConsoleKey.Enter)
                {
                    ...
                    {
                        userName = firstname[CurrentSelected];
                    }
                    break;
                }
